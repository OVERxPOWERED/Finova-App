...
export default function PortfolioCard() {
  ...
  return (
    <div className="mx-5 mt-4 rounded-2xl bg-[#1A3C34] p-5 pb-4 shadow-lg animate-fade-in-up">
      {/* Label */}
      ...
      {/* Amount */}
      <h2 className="mt-1.5 text-[28px] font-bold leading-tight text-white">
        ₹ 50,000.17
      </h2>

      {/* Bar Chart */}
      <div className="mt-5 flex items-end justify-between gap-2" style={{ height: 72 }}>
